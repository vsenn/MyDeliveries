...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate, OnboardingManagerDelegate, ConnectivityObserver, UNUserNotificationCenterDelegate {
    ...
    func onboarded(onboardingContext: OnboardingContext, onboarding _: Bool) {
        var configurationURL = (onboardingContext.info[OnboardingInfoKey.sapcpmsSettingsParameters] as! SAPcpmsSettingsParameters).url(forDestination: "com.sap.tutorials.demoapp.MyDeliveries")
        ...
        if configurationURL == nil {
            ...
            configurationURL = URL(string: "https://hcpms-p1723681063trial.hanatrial.ondemand.com/com.sap.tutorials.demoapp.MyDeliveries")!
        }
    ...
    private func configureOData(_ urlSession: SAPURLSession, _ serviceRoot: URL) {
        let odataProvider = OnlineODataProvider(serviceName: "DeliveryService", serviceRoot: serviceRoot, sapURLSession: urlSession)
