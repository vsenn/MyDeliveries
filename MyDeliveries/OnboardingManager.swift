...
class OnboardingManager {
    ...
    private func configuredWelcomeScreenStep() -> WelcomeScreenStep {
        ...
        let welcomeScreenStep = WelcomeScreenStep(transformer: discoveryConfigurationTransformer, providers: [DiscoveryServiceConfigurationProvider(applicationID: "com.sap.tutorials.demoapp.MyDeliveries")])

        welcomeScreenStep.welcomeScreenCustomizationHandler = { welcomeStepUI in
            welcomeStepUI.headlineLabel.text = "MyDeliveries"
            ...
            if let welcomeScreen = welcomeStepUI as? FUIWelcomeScreen {
                ...
                welcomeScreen.emailTextField.text = "user@trial-p1723681063trial.sapmobileplace.com"
            }
        }
